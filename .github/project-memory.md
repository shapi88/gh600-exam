...
## Ephemeral Memory (Automatic Update)

This section stores short-term session state, active tasks, and execution progress. Agents MUST automatically update this section at the end of every workspace turn or sub-task execution.

### Active Session Context
- **Current Task:** _(Provide the high-level goal of the current run)_
- **Current Branch:** _(Provide the current branch name)_
- **Current Phase:** _(Planning / Implementing / Reviewing / Completed)_
- **Last Action Taken:** _(Summary of the last action taken)_
